...
public class Gameboard {
    ...
    public Gameboard(int width, int height, SilkBag silkBag, ArrayList<FloorTile> tiles, Coordinate P1Location, Coordinate P2Location, Coordinate P3Location, Coordinate P4Location) {
        this.width = width;
        this.height = height;
        this.silkbag = silkBag;
        this.goalCoors = new ArrayList<>();
        ...
        this.playerLocations = new Coordinate[4][3];
        setPlayerPos(0, P1Location);
        setPlayerPos(1, P2Location);
        setPlayerPos(2, P3Location);
        setPlayerPos(3, P4Location);
    }
    ...
    public ArrayList<Coordinate> getSlideLocations() throws Exception {
        ...
        forAllFloorTiles((t) -> {
            if (t != null && (t.isFixed() || t.isFrozen() || t.isGoal())) {
                // If fixed or Frozen
